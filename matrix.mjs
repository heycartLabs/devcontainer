const swToPHP = await (await fetch('https://raw.githubusercontent.com/FriendsOfHeyCart/heycart-static-data/main/data/all-supported-php-versions-by-heycart-version.json')).json();
